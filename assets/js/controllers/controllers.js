...
(function() {
	"use strict";
	var controllers = ["logout", "login", "root" ,"user", "main", "friends", "messages", "circles", "settings", "help", "loading", "register", "start", "version", "mail", "legal", "notificationCenter", "impressum"];
