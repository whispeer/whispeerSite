...
ssn.display.media.pictures = {
	hideAll: function () {
		$("#mediaWrap").hide().html("");
	},
	
	loadMedia: function() {
		// TODO: load all photos of the user that is availiable!
	},
	
	load: function (done) {
		ssn.display.media.pictures.doLoad();
		done();
	},
	
	doLoad: function () {
		try {
			ssn.display.media.pictures.hideAll();
			ssn.display.media.pictures.loadMedia();
		} catch (e) {
			ssn.logger.log(e);
			throw e;
		}
...
how the pictures / videos have to be appended: divide the width of #mediaWrap by 355.
